...
public class Bullet {
	...
	public Bullet(int x, int y, int flag) {
		try {
			bullet1 = ImageIO.read(new File("image/hero/变身之前/skill1丢东西/jjan_skill_010_obj.png"));
			bullet2 = ImageIO.read(new File("image/hero/变身之后/技能/actionjjan_skill1_effect_0001.png"));
			bullet3 = ImageIO.read(new File("image/hero/变身之后/技能/actionjjan_skill1_effect_0002.png"));
			bullet4 = ImageIO.read(new File("image/hero/变身之后/技能/actionjjan_skill1_effect_0003.png"));
