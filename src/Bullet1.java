...
public class Bullet1 {
	...
	public Bullet1(int x, int y, int flag) {
		try {
			// bullet1 = ImageIO.read(new
			// File("image/hero/变身之前/skill1丢东西/jjan_skill_010_obj.png"));
			bullet1 = ImageIO.read(new File("image\\素材\\青椒.png"));
